...
# lista_textos_y_pos_menu_categorias = [("Elija la categoria", (450, 365))]
...
# lista_textos_y_pos_menu_categorias_interactuables = [
#                                     ("HISTORIA", (250, 500)),
#                                     ("DEPORTE", (527, 500)),
#                                     ("CIENCIA", (800, 500)),
...
# lista_renders_categorias_interactuables = listar_renders(lista_textos_y_pos_menu_categorias_interactuables, FUENTE_PRINCIPAL, BLANCO)
# lista_rects_categorias_interactuables = listar_rects(lista_renders_categorias_interactuables)
# lista_rect_menu_categorias_total = lista_rects_categorias + lista_rects_categorias_interactuables
# lista_render_menu_categorias_total = lista_renders_categorias+ lista_renders_categorias_interactuables 
# #Listas iniciales
...
# lista_fondos_categorias = listar_fondos(lista_rect_menu_categorias_total, VIOLETA)
...
# lista_elementos_menu_categorias_interactivos = generar_lista_elementos(lista_render_menu_categorias_total, lista_rect_menu_categorias_total, lista_fondos_categorias)
...
#     texto_comodin_50_50 = f"50:50"
#     texto_comodin_publico = "Público"
#     texto_comodin_llamada = "Llamada"
...
#     lista_textos_comodines = [(texto_comodin_50_50, (150,55)),
#                               (texto_comodin_publico, (275,55)),
#                               (texto_comodin_llamada, (440,55))]
...
#     lista_textos_comodines_renders = listar_renders(lista_textos_comodines, FUENTE_COMODINES, BLANCO) 
#     lista_renders_jugando = listar_renders(lista_textos_pantalla_jugando, FUENTE_PANTALLA_JUEGO, BLANCO)
#     lista_renders_jugando += lista_textos_comodines_renders
